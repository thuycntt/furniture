...
<head>
	...
	<script type="text/javascript" src="../editor/ckfinder/ckeditor.js"></script>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="{{asset('admin/home')}}">NoiThat Admin</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li><a href="{{asset('admin/category')}}"><svg class="glyph stroked line-graph">
					...
					</svg> Danh mục thể loại</a></li>
			<li><a href="{{asset('admin/cateproduct')}}"><svg class="glyph stroked line-graph">
						<use xlink:href="#stroked-line-graph"></use>
					</svg> Danh mục sản phẩm</a>				
			</li>
			<li><a href="{{asset('admin/bill')}}"><svg class="glyph stroked line-graph">
						<use xlink:href="#stroked-line-graph"></use>
					</svg>Đơn hàng</a>				
			</li>
